...
#############################################################################
# Visual Studio 2026 Enterprise: Offline installation using layout directory.
# 
...
#
# IMPORTANT: Delete the entire layout directory (K:\visualstudio2026enterprise-layout) before creating a new one.
# IMPORTANT: Make sure the correct version and included workloads is used when creating the layout.
# 
# choco install visualstudio2026enterprise --version 118.0.0.0 -y --params "--layout K:\visualstudio2026enterprise-layout --add Microsoft.VisualStudio.Workload.ManagedDesktop --add Microsoft.VisualStudio.Workload.NetWeb --add Microsoft.VisualStudio.Workload.Azure --add Microsoft.VisualStudio.Workload.Node --add Microsoft.VisualStudio.Workload.NetCrossPlat --add Microsoft.VisualStudio.Workload.NativeDesktop  --add Microsoft.NetCore.Component.Runtime.8.0 --add Microsoft.NetCore.Component.Runtime.9.0 --add Microsoft.NetCore.Component.Runtime.10.0 --add Microsoft.Net.Component.4.8.1.SDK --add Microsoft.Net.Component.4.8.1.TargetingPack --add Microsoft.VisualStudio.Web.Mvc4.ComponentGroup --includeRecommended" --force
#############################################################################

choco install visualstudio2026enterprise --version 118.0.0.0 -y --execution-timeout=7000 `
    --params "--bootstrapperPath K:\visualstudio2026enterprise-layout\vs_setup.exe" `
