...
c:\windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy ByPass -Command "& 'C:\tools\Anaconda3\shell\condabin\conda-hook.ps1' ; conda env create -f C:\VPC_Images\pythonai.yaml"
