...
# 
# choco install visualstudio2022enterprise --version 117.11.1.0 -y --params "--layout K:\visualstudio2022enterprise-layout --add Microsoft.VisualStudio.Workload.ManagedDesktop --add Microsoft.VisualStudio.Workload.NetWeb --add Microsoft.VisualStudio.Workload.Azure --add Microsoft.VisualStudio.Workload.Node --add Microsoft.VisualStudio.Workload.NetCrossPlat --add Microsoft.VisualStudio.Workload.NativeDesktop --add Microsoft.VisualStudio.Workload.Data --add Microsoft.NetCore.Component.Runtime.6.0 --add Microsoft.NetCore.Component.Runtime.7.0 --add Microsoft.NetCore.Component.Runtime.8.0 --add Microsoft.Net.Component.4.8.1.SDK --add Microsoft.Net.Component.4.8.1.TargetingPack --add Microsoft.VisualStudio.Web.Mvc4.ComponentGroup --add Microsoft.VisualStudio.ComponentGroup.ArchitectureTools.Managed --add Microsoft.VisualStudio.Component.AzureDevOps.OfficeIntegration --add Microsoft.VisualStudio.Component.Git --add Microsoft.VisualStudio.Component.DependencyValidation.Enterprise --includeRecommended" --force
#############################################################################

choco install visualstudio2022enterprise --version 117.11.1.0 -y --execution-timeout=7000 `
...
choco install sql-server-management-studio --version 20.1.10 -y # 20.1 d.d. apr 2024
