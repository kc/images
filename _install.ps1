...
choco install VisualStudio2015Enterprise --version 14.0.25420.1 -params "/layout K:\VS2015\" -ia "/InstallSelectableItems WebTools;TypeScript;GitForWindows;SQL;PowershellTools" -y --source $myfeed
